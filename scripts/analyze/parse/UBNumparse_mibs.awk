...
/VF) solved/{
    VFNum[experiment_num, counter] = $7;
}
/UB) solved/{
    UBNum[experiment_num, counter] = $7;
}
...
/cut generator/ {
    cutNum[experiment_num, counter] = $9
}
...
/ALPS did not find a solution/{
    ...
    cutNum[experiment_num, counter] = "-0.01";
}
   
END {
    file = sprintf("%s.summary", "UBNum");
