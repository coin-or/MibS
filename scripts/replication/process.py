...
def parseOutput(outputDir, versions, scenarios, writeCSV=True, filename="summary.csv"):
    ...
    df_result["idic_cg_avg_time"] = df_result["idic_cg_avg_time"].fillna(0)
    
    # compute percentages
    df_result["cg_fail_rate"] = df_result["cg_failed"] / df_result["cg_called"][df_result["cg_called"] > etol]
    df_result["cg_fail_rate"] = df_result["cg_fail_rate"].fillna(0)
    ...
    df_result["idic_intersection_fail_rate"] = df_result["idic_intersection_fail_rate"].fillna(0)
