...
public:
    ...
    MibSSolType checkBilevelFeasibilityParallel(bool isRoot);
    MibSSolType checkBilevelFeasibilityBR(bool isRoot);
    MibSSolType checkBilevelFeasibilityBRPES(bool isRoot);
